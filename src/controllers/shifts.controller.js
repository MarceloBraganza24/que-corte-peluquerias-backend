...
const save = async (req, res) => {
    try {
        const { hairdresser,first_name,last_name,service,email,date,schedule,price,cancelled,shift_datetime } = req.body;
        const shift = await shiftsService.save(hairdresser,first_name,last_name,service,email,date,schedule,price,cancelled,shift_datetime);
